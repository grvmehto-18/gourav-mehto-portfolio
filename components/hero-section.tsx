      ...
      <motion.div
        ...
        <div className="space-y-6 sm:space-y-8">
          ...
          <p className="text-base sm:text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed px-2 sm:px-0">
            Computer Science student at IPS Academy with hands-on experience in
            full-stack development. I build scalable web applications with
            modern technologies and have a passion for creating efficient,
