...
import { Calendar, ExternalLink, Github, Users, Database, Shield } from "lucide-react"
  ...
  const projects = [
    {
      ...
      impact: "Reduced clearance time by 70% and improved department coordination",
    },
    {
      name: "Blood Link",
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            A showcase of my full-stack development projects demonstrating technical expertise and problem-solving
            skills
          </p>
        </div>
              ...
              <CardHeader>
                <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                  <div className="flex items-start gap-4">
                    <div className="text-red-600 bg-red-50 p-3 rounded-lg">{project.icon}</div>
                    <div>
              ...
              <CardContent>
                <div className="space-y-6">
                  ...
                  <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                    <h4 className="font-semibold text-green-800 mb-1">Project Impact:</h4>
          ...
          <Card className="bg-gradient-to-r from-blue-50 to-red-50 border-blue-200">
            <CardContent className="p-8">
              ...
              <p className="text-muted-foreground mb-4">
                I'm constantly working on new projects and exploring emerging technologies. Check out my GitHub for the
                latest updates and contributions.
              </p>
              <Button
                onClick={() => window.open("https://github.com/grvmehto-18", "_blank")}
                variant="outline"
